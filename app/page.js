  ...
  return (
    <>
      <div className="header-container">
        <Link href="/about" title="About this website"><div className="image-button"><Image alt="about icon" src="https://img.icons8.com/?size=32&id=82889&format=png&color=FFFFFF" width={32} height={32} /></div></Link>
        <h1>FriendWatch Configurator</h1>
        <Link href="https://github.com/littlebitstudios/SwitchFriendWatch" title="SwitchFriendWatch on GitHub"><div className="image-button"><Image alt="github logo" src="https://img.icons8.com/?size=32&id=106567&format=png&color=FFFFFF" width={32} height={32} /></div></Link>
      </div>
          ...
          <ul>
            {friends.map((friend, index) => (
              <div key={index} style={{ display: 'flex', alignItems: 'center', marginBottom: '10px', border: '1px solid #ccc', padding: '10px', borderRadius: '5px' }}>
                <Image src={friend.imageUri} alt={friend.name} style={{ width: '50px', height: '50px', borderRadius: '50%', marginRight: '10px' }} />
                <div style={{ flex: 1 }}>
